...
def main():
    ...
    excel_file = "University of South Carolina.xlsx"
    year_col = "2015-2016"


# RESIGNED FACULTY
    resigned_faculty = [
    "Max Alekseyev",  # was Assistant Professor
    "John B. Bowles"  # was Associate Professor
]

# TITLE CHANGES
    title_changes = {
    "Jason D. Bakos": "Assistant Professor -> Associate Professor",
    "Jason O'Kane": "Assistant Professor -> Associate Professor",
    "Jianjun Hu": "Assistant Professor -> Associate Professor",
    "José M. Vidal": "Associate Professor -> Professor",
    "Manton M. Matthews": "Associate Professor -> Professor",
    "Song Wang": "Associate Professor -> Professor",
    "Srihari Nelakuditi": "Associate Professor -> Professor",
    "Stephen Fenner": "Associate Professor -> Professor",
    "Wenyuan Xu": "Assistant Professor -> Associate Professor"
}

# NEW HIRES
    new_hires = {
    "Jenay Beer": "Assistant Professor",
    "Ioannis Rekleitis": "Assistant Professor",
    "Gabriel Terejanu": "Assistant Professor",
    "Matt Thatcher": "Professor"
}
