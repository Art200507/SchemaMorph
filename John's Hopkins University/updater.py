...
def main():
    ...
    excel_file = "John's Hopkins University.xlsx"
    year_col = "2018-2019"
...
# TITLE CHANGES
    title_changes = {
    "Alexis Battle": "Assistant Professor -> Associate Professor",
    "Amitabh Basu": "Assistant Professor -> Associate Professor",
    "Dennice Gayme": "Assistant Professor -> Associate Professor",
    "Matthew Green": "Assistant Professor -> Associate Professor",
    "Rachel Karchin": "Associate Professor -> Professor",
    "Rebecca Schulman": "Assistant Professor -> Associate Professor",
    "Thao (Vicky) Nguyen": "Associate Professor -> Professor"
}

# NEW HIRES
    new_hires = {
    "Yinzhi Cao": "Assistant Professor",
    "Kimia Ghobadi": "Assistant Professor",
    "Soudeh Ghorbani": "Assistant Professor",
    "Luo Gu": "Assistant Professor",
    "Vishal Patel": "Assistant Professor",
    "Vladimir Braverman": "Associate Professor",
    "Paulette Clancy": "Professor",
    "William Cook": "Professor",
    "Efrosini Kokkoli": "Professor",
    "Harihar Rajaram": "Professor",
    "Michael Tsapatsis": "Professor"
}
