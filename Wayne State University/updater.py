...
def main():
    excel_file = "Wayne State University.xlsx"
    year_col = "2017-2018"
    ...
    new_hires = {
        "Bruce Berkowitz": "Professor",
        "Mohammed I. Elnaggar": "Professor",
        "Gene Liao": "Professor",
        "Sergei A. Voloshin": "Professor",
        "Yingxi E. Zhu": "Professor",
        "Celestine C. Aguwa": "Associate Professor",
        "Ulrike Klueh": "Associate Professor",
        "Wenlong Li": "Associate Professor",
        "Caisheng Wang": "Associate Professor",
        "Omid Samimi Abianeh": "Assistant Professor",
        "Zhiqiang Cao": "Assistant Professor",
        "W. Ethan Eagle": "Assistant Professor",
        "Haipeng Liu": "Assistant Professor",
        "Fatmir Menkulasi": "Assistant Professor",
        "Mohammad Nasiriavanaki": "Assistant Professor",
        "Matthew Nokleby": "Assistant Professor",
        "Korosh Torabi": "Assistant Professor",
        "Saravanan Venkatachalam": "Assistant Professor",
        "Fengwei Zhang": "Assistant Professor",
        "Zichun Zhong": "Assistant Professor"
    }
