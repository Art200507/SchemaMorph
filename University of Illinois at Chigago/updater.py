...
# RESIGNED FACULTY
    resigned_faculty = [
    "William D. O’Neill",  # was Professor
    "Ramille N. Shah",  # was Professor
    "Michael A. Stroscio",  # was Professor
    "Farzad Mashayek"  # was Professor
]
...
# NEW HIRES
    new_hires = {
    "Sangil Kim": "Professor",
    "Rodrigo Reboucas": "Professor",
    "Scott Banjavcic": "Professor",
    "Aslihan Karatas": "Professor",
    "Lauryn Spearing": "Professor",
    "Lisa Stabryla": "Professor",
    "UIC Undergraduate Catalog 2024-2025 23": "Professor",
    "Mohammed Ghashami": "Professor",
    "Azadeh Haghighi": "Professor",
    "Hyungil Kim": "Professor",
    "Brynne Nicolsen": "Professor",
    "Shokouh Pourarian": "Professor"
}
