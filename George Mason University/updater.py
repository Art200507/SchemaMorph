...
def main():
    ...
    excel_file = "George Mason University.xlsx"
    year_col = "2024-2025" 
...
# RESIGNED FACULTY
    resigned_faculty = [
    "Kevin Moran",  # was Assistant Professor
    "Laurence C. Bray",  # was Assistant Professor
    "Pramita Bagchi",  # was Assistant Professor
    "Xiang Chen",  # was Assistant Professor
    "Ziwei Zhu",  # was Assistant Professor
    "Chien Chung Huang",  # was Associate Professor
    "Clifton D. Sutton",  # was Associate Professor
    "Erion Plaku",  # was Associate Professor
    "Jan M. Allbeck",  # was Associate Professor
    "Jill Karen Nelson",  # was Associate Professor
    "Jyh-Ming Lien",  # was Associate Professor
    "Liza W. Durant",  # was Associate Professor
    "Mihai Boicu",  # was Associate Professor
    "Niloofar Ramezani",  # was Associate Professor
    "Ozlem Uzuner",  # was Associate Professor
    "Paul E. Ammann",  # was Associate Professor
    "Paulo C. G. Costa",  # was Associate Professor
    "Shanjiang Zhu",  # was Associate Professor
    "A. Jefferson Offutt",  # was Professor
    "A.Z. Manitius",  # was Professor
    "Arthur B. Pyster",  # was Professor
    "David Rosenblum",  # was Professor
    "Deborah J. Goodings",  # was Professor
    "Elise D. Miller-Hooks",  # was Professor
    "Giorgio A. Ascoli",  # was Professor
    "John F. Shortle",  # was Professor
    "Kenneth Ball",  # was Professor
    "Kim T. Blackwell",  # was Professor
    "Pelin Kurtay",  # was Professor
    "Qiliang Li",  # was Professor
    "Yariv Ephraim"  # was Professor
]

# TITLE CHANGES
    title_changes = {
    "Aditya Johri": "Professor -> Associate Professor",
    "Doaa Bondok": "Assistant Professor -> Associate Professor",
    "Foteini Baldimtsi": "Assistant Professor -> Associate Professor",
    "Girum Urgessa": "Associate Professor -> Professor",
    "Hadi El-Amine": "Assistant Professor -> Associate Professor",
    "Harry J. Foxwell": "Associate Professor -> Professor",
    "Jie Xu": "Associate Professor -> Professor",
    "Jinwei Ye": "Assistant Professor -> Associate Professor",
    "Kai Zeng": "Associate Professor -> Professor",
    "Katherine E. Russell": "Assistant Professor -> Associate Professor",
    "Lannan Luo": "Assistant Professor -> Associate Professor",
    "Martin Slawski": "Assistant Professor -> Associate Professor",
    "Pei Dong": "Assistant Professor -> Associate Professor",
    "Remi Veneziano": "Assistant Professor -> Associate Professor",
    "Sean Luke": "Professor -> Associate Professor",
    "Sharon Adamus": "Associate Professor -> Professor",
    "Shima Mohebbi": "Associate Professor -> Assistant Professor",
    "Tamara A. Maddox": "Associate Professor -> Professor",
    "ThanhVu Nguyen": "Assistant Professor -> Associate Professor",
    "Vadim O. Sokolov": "Assistant Professor -> Associate Professor",
    "Vivian G. Motti": "Assistant Professor -> Associate Professor",
    "Zhisheng Yan": "Assistant Professor -> Associate Professor"
}

# NEW HIRES
    new_hires = {
    "Anomadarshi Barua": "Assistant Professor",
    "Brian Hrolenok": "Assistant Professor",
    "Isuru Dassanayake": "Assistant Professor",
    "Kazi Lutful Kabir": "Assistant Professor",
    "Kenneth Pasiah": "Assistant Professor",
    "Kevin Andrea": "Assistant Professor",
    "Matthew Amissah": "Assistant Professor",
    "Parastoo Kamranfar": "Assistant Professor",
    "Saanyol Igbax": "Assistant Professor",
    "Socrates Dimitriadis": "Assistant Professor",
    "Alok K. Berry": "Associate Professor",
    "Duoduo Liao": "Associate Professor",
    "Ethan Ahn": "Associate Professor",
    "Henry Coffman": "Associate Professor",
    "Ilhan Izmirli": "Associate Professor",
    "Isaac Gang": "Associate Professor",
    "Michael Reep": "Associate Professor",
    "Mohamed Gebril": "Associate Professor",
    "Ping Deng": "Associate Professor",
    "Radu Negulescu": "Associate Professor",
    "Sapna Gambhir": "Associate Professor",
    "Shahnaz Kamberi": "Associate Professor",
    "Songjun Luo": "Associate Professor",
    "Tolga Soyata": "Associate Professor",
    "Yutao Zhong": "Associate Professor",
    "Brian L. Mark": "Professor",
    "Cem Evrendilek": "Professor",
    "Inchi Hu": "Professor",
    "Mark H. Snyder": "Professor",
    "Robert Osgood": "Professor",
    "Sherif Hashem": "Professor",
    "Y. Diana Wang": "Professor",
    "Zhengdao Wang": "Professor"
}
