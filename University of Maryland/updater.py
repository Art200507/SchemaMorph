...
def main():
    ...
    excel_file = "University of Maryland.xlsx"
    year_col = "2022-2023"
...
# RESIGNED FACULTY
    resigned_faculty = [
    "Leilani Battle",  # was Assistant Professor
    "Monifa Vaughn-Cooke",  # was Assistant Professor
    "Andre Wendell Marshall",  # was Associate Professor
    "Charalampos Papamanthou",  # was Associate Professor
    "Gary A. Pertmer",  # was Associate Professor
    "Robert Michael Sanner",  # was Associate Professor
    "Amde M. Amde",  # was Professor
    "Gilmer L. Blankenship",  # was Professor
    "Abhijit Dasgupta",  # was Professor
    "Alison Flatau",  # was Professor
    "Bruce Jacob",  # was Professor
    "Steven I. Marcus",  # was Professor
    "Michael G. Pecht",  # was Professor
    "Linda C. Schmidt",  # was Professor
    "Charles W. Schwartz",  # was Professor
    "Neil Spring",  # was Professor
    "Alba Torrents",  # was Professor
    "Sennur Ulukus",  # was Professor
    "Eric D. Wachsman",  # was Professor
    "Donald Yeung"  # was Professor
]

# TITLE CHANGES
    title_changes = {
    "Abhinav Bhatele": "Assistant Professor -> Associate Professor",
    "Christoph Brehm": "Assistant Professor -> Associate Professor",
    "Dongxia Liu": "Associate Professor -> Professor",
    "John Paul Dickerson": "Assistant Professor -> Associate Professor",
    "Mumu Xu": "Assistant Professor -> Associate Professor",
    "Pino Martin": "Associate Professor -> Professor",
    "Pratap Tokekar": "Assistant Professor -> Associate Professor",
    "Ryan Daniel Sochol": "Assistant Professor -> Associate Professor",
    "Taylor J Woehl": "Assistant Professor -> Associate Professor",
    "Yanne Kouomou Chembo": "Associate Professor -> Professor"
}

# NEW HIRES
    new_hires = {
    "Avik Dutt": "Assistant Professor",
    "Raffan Montoya Fernando": "Assistant Professor",
    "Cecilia Huertas Cerdeira": "Assistant Professor",
    "Erin Molloy": "Assistant Professor",
    "Shuna Ni": "Assistant Professor",
    "Carlos Andres Rios Ocampo": "Assistant Professor",
    "Pratyush Tiwary": "Associate Professor",
    "Samuel Jr. Graham": "Professor",
    "Daniel Perry Lathrop": "Professor",
    "Sangbok Lee": "Professor",
    "Laurie Ellen Locascio": "Professor",
    "Tao L Lowe": "Professor"
}
