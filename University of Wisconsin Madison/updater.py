...
def main():
    ...
    excel_file = "University of Wisconsin Madison.xlsx"
    year_col = "2024-2025" 

# RESIGNED FACULTY
    resigned_faculty = [
    "Boutilier",  # was Assistant Professor
    "Rudykh",  # was Assistant Professor
    "Kim",  # was Associate Professor
    "Krupenkin",  # was Associate Professor
    "Ahn",  # was Professor
    "Bahia",  # was Professor
    "Hurley",  # was Professor
    "Lipasti",  # was Professor
    "Murphy",  # was Professor
    "Osswald"  # was Professor
]

# TITLE CHANGES
# 
    title_changes = {
    "Anderson": "Associate Professor -> Professor",
    "Henak": "Assistant Professor -> Associate Professor",
    "Kats": "Associate Professor -> Professor",
    "Ludois": "Associate Professor -> Professor",
    "McDonald": "Assistant Professor -> Associate Professor",
    "Ogras": "Associate Professor -> Professor",
    "Remucal": "Associate Professor -> Professor",
    "Rudraraju": "Assistant Professor -> Associate Professor",
    "San Miguel": "Assistant Professor -> Associate Professor",
    "Thevamaran": "Assistant Professor -> Associate Professor",
    "Van Lehn": "Assistant Professor -> Associate Professor",
    "Zayas-Caban": "Assistant Professor -> Associate Professor",
    "Zinn": "Associate Professor -> Professor"
}

# NEW HIRES
    new_hires = {
    "Alapan": "Assistant Professor",
    "Cersonsky": "Assistant Professor",
    "Dudley": "Assistant Professor",
    "Ngo": "Assistant Professor"
}
